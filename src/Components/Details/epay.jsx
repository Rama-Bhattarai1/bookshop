...
//   const [successUrl, setSuccessUrl] = useState('https://esewa.com.np');
...
//               setTransactionUUID(order.invoice); // Using invoice as transaction UUID
//               // If you need to get product details from order_items
//               if (order.order_items.length > 0) {
//                 setProductCode(order.order_items[0].product.id.toString()); // or any relevant product code
//               }
